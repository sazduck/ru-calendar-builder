...
describe('getCalendarDay', () => {
  ...
  it('возвращает dayOff с holidayName и с transferredTo для перенсенного праздника', () => {
    ...
    expect(day.type).toBe('dayOff');
    if (!day.meta) {
      expect.fail('метаданные не определены');
    }
...
describe('buildCalendar', () => {
  it('возвращает корректные данные', { tags: ['heavy', 'calendar'] }, () => {
    expect(buildCalendar(2024, transfers2024)).toEqual([
      {
        date: '2024-01-01',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'Новый год' },
      },
      {
        date: '2024-01-02',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'Новогодние каникулы' },
      },
      {
        date: '2024-01-03',
        type: 'dayOff',
      ...
      { date: '2024-01-13', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-01-14', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-01-20', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-01-21', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-01-27', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-01-28', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-02-03', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-02-04', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-02-10', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-02-11', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-02-17', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-02-18', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      },
      {
        date: '2024-02-23',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'День защитника отечества' },
      },
      { date: '2024-02-24', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-02-25', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-03-02', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-03-03', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-03-09', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-03-10', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-03-16', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-03-17', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-03-23', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-03-24', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-03-30', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-03-31', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-04-06', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-04-07', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-04-13', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-04-14', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-04-20', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-04-21', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-04-26', type: 'working' },
      {
        ...
        meta: {
          reason: 'transfer',
          transferredTo: '2024-04-29',
          weekday: 'Sat',
        },
      },
      { date: '2024-04-28', type: 'dayOff', meta: { weekday: 'Sun' } },
      {
        type: 'dayOff',
        date: '2024-04-29',
        meta: { reason: 'transfer', transferredFrom: '2024-04-27' },
      },
      {
        date: '2024-04-30',
        type: 'shortened',
        meta: { reason: 'preholiday', holidayName: 'День труда' },
      },
      {
        date: '2024-05-01',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'День труда' },
      },
      { date: '2024-05-02', type: 'working' },
      { date: '2024-05-03', type: 'working' },
      { date: '2024-05-04', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-05-05', type: 'dayOff', meta: { weekday: 'Sun' } },
      { date: '2024-05-06', type: 'working' },
      { date: '2024-05-07', type: 'working' },
      {
        date: '2024-05-08',
        type: 'shortened',
        meta: { reason: 'preholiday', holidayName: 'День победы' },
      },
      {
        date: '2024-05-09',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'День победы' },
      },
      {
        date: '2024-05-10',
        type: 'dayOff',
      ...
      { date: '2024-05-11', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-05-12', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-05-18', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-05-19', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-05-25', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-05-26', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-06-01', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-06-02', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-06-08', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-06-09', type: 'dayOff', meta: { weekday: 'Sun' } },
      { date: '2024-06-10', type: 'working' },
      {
        date: '2024-06-11',
        type: 'shortened',
        meta: { reason: 'preholiday', holidayName: 'День России' },
      },
      {
        date: '2024-06-12',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'День России' },
      },
      { date: '2024-06-13', type: 'working' },
      { date: '2024-06-14', type: 'working' },
      { date: '2024-06-15', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-06-16', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-06-22', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-06-23', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-06-29', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-06-30', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-07-06', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-07-07', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-07-13', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-07-14', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-07-20', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-07-21', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-07-27', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-07-28', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-08-03', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-08-04', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-08-10', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-08-11', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-08-17', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-08-18', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-08-24', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-08-25', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-08-31', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-09-01', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-09-07', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-09-08', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-09-14', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-09-15', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-09-21', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-09-22', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-09-28', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-09-29', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-10-05', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-10-06', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-10-12', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-10-13', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-10-19', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-10-20', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-10-26', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-10-27', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-11-01', type: 'working' },
      {
        ...
        meta: {
          reason: 'preholiday',
          holidayName: 'День труда',
          transferredTo: '2024-04-30',
          weekday: 'Sat',
        },
      },
      {
      ...
      },
      {
        date: '2024-11-04',
        type: 'dayOff',
        meta: { reason: 'holiday', holidayName: 'День народного единства' },
      },
      { date: '2024-11-05', type: 'working' },
      { date: '2024-11-06', type: 'working' },
      { date: '2024-11-07', type: 'working' },
      { date: '2024-11-08', type: 'working' },
      { date: '2024-11-09', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-11-10', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-11-16', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-11-17', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-11-23', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-11-24', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-11-30', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-12-01', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-12-07', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-12-08', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-12-14', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-12-15', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-12-21', type: 'dayOff', meta: { weekday: 'Sat' } },
      { date: '2024-12-22', type: 'dayOff', meta: { weekday: 'Sun' } },
      ...
      { date: '2024-12-27', type: 'working' },
      {
        ...
        meta: {
          reason: 'transfer',
          transferredTo: '2024-12-30',
          weekday: 'Sat',
        },
      },
      { date: '2024-12-29', type: 'dayOff', meta: { weekday: 'Sun' } },
      {
        type: 'dayOff',
        date: '2024-12-30',
        meta: { reason: 'transfer', transferredFrom: '2024-12-28' },
      },
      {
        date: '2024-12-31',
        type: 'dayOff',
